...
using MurkyPluse.Models.ViewModels;
...
namespace MurkyPluse.Controllers
{
    ...
    public class BlogPostController : Controller
    {
        ...
        public BlogPostController(MurkyDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public MurkyDbContext Get_context()
        {
            return _context;
        }

        [HttpGet]
        public async Task<IActionResult> Edit(int id, MurkyDbContext _context)
        {
            var postViewModel = new PostViewModel
            {
                Categories = new SelectList(_context.Categories, "Id", "Name"),
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddComment([FromBody] BlogComment comment)
        {
            if (ModelState.IsValid)
            {
